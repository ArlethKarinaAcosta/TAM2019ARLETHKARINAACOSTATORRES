...
//Aquí se definen las instrucciones SQL para las tablas y realizar operaciones con los datos.
...
public class MainActivity extends AppCompatActivity {
    ...
    private void listardatos() {
        ...
        StringBuffer datos = new StringBuffer(); //Representa una cadena cuyo tamaño puede variar.
        Cursor cursor = con.getAll();
        for(cursor.moveToFirst();!cursor.isAfterLast();cursor.moveToNext()){ //Con este ciclo se mueve el cursor.
